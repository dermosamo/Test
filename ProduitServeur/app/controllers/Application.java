...
public class Application extends Controller {
    ...
    public static Result listTweets(String username)
    {
    	...
    	if(request().accepts("text/html"))
    		...
    		return ok(Json.toJson(produits));
    	else if (request().accepts("application/rdf+xml"))
    		return ok("this will be RDF XML");
    	return badRequest();
    }
 
    public static Result submitProduit()
    {
    	Produit prod = tweetForm.bindFromRequest().get();
    	Tweet.create(tweet);
    	return redirect(routes.Application.listTweets("visitEmployéeur"));
    }
    
    public static Result listproduitFromTo()
    {
